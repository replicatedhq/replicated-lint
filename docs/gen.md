...
The minimum Replicated API version to use container.ports.public_port_initial is 2.8.0
...
*Incorrect*: public_port_initial used and replicated api version set to 2.7.0
...
*Incorrect*: public_port_initial used and replicated api version set to 1.8.5
...
*Correct*: public_port_initial used and replicated api version set to 2.8.0
...
*Correct*: public_port_initial used and replicated api version set to 2.8.1
...
Container's cluster_host_count property `min` must be an unsigned integer or template
...
*Correct*: cluster_host_count.min is a template
...
Container's cluster_host_count property `max` must be an unsigned integer or template
...
*Correct*: cluster_host_count.max is a template
...
Container's cluster_host_count property `threshold_healthy` must be an unsigned integer or template
...
*Correct*: cluster_host_count.threshold_healthy is a template
...
*Correct*: cluster_host_count.threshold_degraded is a template
...
Container's shm_size property must be an unsigned integer or a template
...
*Incorrect*: shm_size must be an unsigned integer, and this is not even numeric
...
*Correct*: shm_size is a template
...
*Correct*: Valid binary memory size, 128KiB
...
*Generated at Tue May 05 2020 06:25:08 GMT-0700 (Pacific Daylight Time)*
